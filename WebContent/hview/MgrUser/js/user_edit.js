...
layui.use(['form', 'layedit',], function () {
  ...
  /*  //自定义验证规则
    ...
    $(function(){
        ...
        $("input[name='uid']").val(initData.id);
        $("input[name='fullName']").val(initData.fullName);
        $("input[name='userRoleId']").val(initData.userRoleId);
        $("input[name='school']").val(initData.school);
        $("input[name='campus']").val(initData.campus);  
        $("input[name='uTelephone']").val(initData.uTelephone);
        $("input[name='uPassword']").val(initData.uPassword);
    });
});
