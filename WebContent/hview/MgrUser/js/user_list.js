...
layui.use(['form', 'table'], function () {
    ...
    var listTable = table.render({
        id: 'listTable',
        elem: '#tableContent',
        url: '/piPaiCampus/rest/webLogin/queryAllUsers',
        method: 'post',
        cols: [[{
    ...
    function editItem(data) {
        ...
        layer.open({
            ...
            , title: '编辑'
            , area: ['750px', '600px']
            , content: ['user_edit.html?randmStr=' + randmStr, 'no']
            , id: 'userEdit',
    ...
    function deleteItem(data) {
        ...
        $.ajax({
            url: "/piPaiCampus/rest/webLogin/deleteUser",
            type: 'POST',
            dataType: 'text',
            data: 'para=' + fstr,
    ...
    $("#btnAdd").click(function () {
        ...
        layer.open({
            ...
            , maxmin: true
            , area: ['750px', '600px']
            , content: ['user_add.html?randmStr=' + randmStr, 'no']
            , id: 'userAdd',
            success: function (layero, index) {
                layer.setTop(layero); //重点2
               // layer.iframeAuto(index);
