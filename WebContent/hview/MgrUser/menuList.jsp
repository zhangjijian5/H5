			...
			layui.use(
				...
				function() {
					...
					var treeTable = treeGrid.render({
						...
						elem: '#treeTable',
						method: 'post',
						url: '/piPaiCampus/rest/menus/selectAllMenus',
						cellMinWidth: 100,
					...
					treeGrid.on('tool(treeTable)', function(obj) {
						...
						if(obj.event === 'edit'){
							...
							layer.open({
								...
								title: "添加菜单",
								area: ['470px', '420px'],
								content: "menuEdit.html", //这里content是一个普通的String
								id: 'menuEdit',
					...
					$("#addMenu").click(function() {
						var data = $("input[name='menuId']:checked").val();
						if(data == undefined || data != 1) {
							...
							layer.open({
								...
								title: "添加菜单",
								area: ['470px', '420px'],
								content: "menuForm.html", //这里content是一个普通的String
								id: 'menuAdd',
								success: function(layero, index) {
									layer.setTop(layero); //重点2
									layer.iframeAuto(index);
					...
					$("#delMenu").click(function() {
						...
						layer.confirm('真的删除行么', function(index) {
							...
							$.ajax({
								url: "/piPaiCampus/rest/menus/deleteMenus",
								type: 'POST',
								dataType: 'text',
								data: 'para=' + fstr,
								success: function(data) {
