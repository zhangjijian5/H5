  ...
  /*  function deleteItem(data){
   ...
   //方法级渲染
    var listTable =table.render({
        id: 'listTable',
        elem: '#tableContent',
        url: '/piPaiCampus/rest/couponMgr/queryActiveCoupon',
        method: 'post',
        cols: [[{
    ...
    function editItem(data) {
        ...
        layer.open({
            ...
            , title: '详情'
            , area: ['700px', '500px']
            , content: ['activeCoupon_edit.html?randmStr=' + randmStr, 'no']
            , id: 'userEdit',
    ...
    function deleteItem(data) {
        ...
        $.ajax({
            url: "/piPaiCampus/rest/couponMgr/deleteActiveCoupon",
            type: 'POST',
            dataType: 'text',
            data: 'para=' + fstr,
            success: function (result) {
    ...
    $("#btnAdd").click(function () {
        ...
        layer.open({
            ...
            , maxmin: true
            , area: ['700px', '500px']
            , content: ['activeCoupon_add.html?randmStr=' + randmStr, 'no']
            , id: 'userAdd',
            success: function (layero, index) {
                layer.setTop(layero); //重点2
                layer.iframeAuto(index);
