...
layui.use(['form', 'table'], function () {
    ...
    var listTable = table.render({
        id: 'listTable',
        elem: '#tableContent',
        url: '/piPaiCampus/rest/orders/queryBackOrders',
        method: 'post',
        cols: [[{
  ...
  //方法级渲染
    var listTable = table.render({
        id: 'listTable',
        elem: '#table',
        url: '/piPaiCampus/rest/orders/queryBackEOrders',
        method: 'post',
        cols: [[{
            type: 'numbers', title: '序号'
        }, {
    ...
    function editItem(data) {
        ...
        layer.open({
            ...
            , title: '详情'
            , area: ['700px', '500px']
            , content: ['orders_edit.html?randmStr=' + randmStr, 'no']
            , id: 'userEdit',
    ...
    function deleteItem(data) {
        ...
        $.ajax({
            url: "/piPaiCampus/rest/orders/deleteBackOrders",
            type: 'POST',
            dataType: 'text',
            data: 'para=' + fstr,
    ...
    $("#btnAdd").click(function () {
        ...
        layer.open({
            ...
            , maxmin: true
            , area: ['700px', '500px']
            , content: ['orders_add.html?randmStr=' + randmStr, 'no']
            , id: 'userAdd',
            success: function (layero, index) {
                layer.setTop(layero); //重点2
                layer.iframeAuto(index);
