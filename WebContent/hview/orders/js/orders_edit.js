...
layui.use(['form', 'layedit',], function () {
   ...
   /* //自定义验证规则
    ...
    form.on('submit(doFormSub)', function (data) {
        ...
        // console.log(fstr);
        $.ajax({
            url: "/piPaiCampus/rest/orders/changeBackOrders",
            type: 'POST',
            dataType: 'text',
            data: 'para=' + fstr,
    ...
    $(function(){
        ...
        $("input[name='otname']").val(initData.otname);
        $("input[name='oname']").val(initData.oname);
        $("input[name='ocode']").val(initData.ocode);
        $("input[name='objtype']").val(initData.objtype);
