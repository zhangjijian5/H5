...
layui.use(['form', 'table'], function () {
    ...
    var listTable = table.render({
        id: 'listTable',
        elem: '#tableContent',
        url: '/piPaiCampus/rest/school/selectAllSchool',
        method: 'post',
        cols: [[{
    ...
    function editItem(data) {
        ...
        layer.open({
            ...
            , title: '编辑'
            , area: ['700px', '500px']
            , content: ['school_edit.html?randmStr=' + randmStr, 'no']
            , id: 'userEdit',
            success: function (layero, index) {
                layer.setTop(layero); //重点2
                layer.iframeAuto(index);
	...
	function addCampusItem(data) {
        ...
        layer.open({
            ...
            , title: '添加校区'
            , area: ['700px', '500px']
            , content: ['campus_add.html?randmStr=' + randmStr, 'no']
            , id: 'userEdit',
            success: function (layero, index) {
                layer.setTop(layero); //重点2
                layer.iframeAuto(index);
    ...
    function deleteItem(data) {
        ...
        // console.log(fstr);
        $.ajax({
            url: "/piPaiCampus/rest/school/delSchoolInfo",
            type: 'POST',
            dataType: 'text',
            data: 'para=' + fstr,
