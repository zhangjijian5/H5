layui.use(['form', 'table'], function () {
    ...
    var listTable = table.render({
        id: 'listTable',
        elem: '#tableContent',
        url: '/piPaiCampus/rest/shopMgr/queryShopRole',
        method: 'post',
        cols: [[{
 ...
 //监听工具条
    ...
    function editItem(data) {
        ...
        layer.open({
            ...
            , title: '编辑'
            , area: ['700px', '600px']
            , content: ['shopRole_edit.html?randmStr=' + randmStr, 'no']
            , id: 'userEdit',
    ...
    function deleteItem(data) {
        ...
        // console.log(fstr);
        $.ajax({
            url: "/piPaiCampus/rest/shopMgr/delShopRole",
            type: 'POST',
            dataType: 'text',
            data: 'para=' + fstr,
    ...
    $("#btnAdd").click(function () {
        ...
        layer.open({
            ...
            , maxmin: true
            , area: ['700px', '500px']
            , content: ['shopRole_add.html?randmStr=' + randmStr, 'no']
            , id: 'userAdd',
            success: function (layero, index) {
                layer.setTop(layero); //重点2
             //   layer.iframeAuto(index);
