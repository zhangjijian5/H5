...
function oddbullet(X,Y){
    bullet.call(this,X,Y,6,14,"image/t1.jpg");
}
...
/*
 创建本方飞机
 */
var selfplan=new ourplan(380,485);
//移动事件
...
var bianjie=function(){
    ...
    if(bodyobjX<5||bodyobjX>1600||bodyobjY<0||bodyobjY>868){
        if(document.removeEventListener){
            mainDiv.removeEventListener("mousemove",yidong,true);
        }
        else if(document.detachEvent){
...
function start(){
    ...
    if(mark==2){
        ...
        //中飞机
        if(mark1%5==0){
            enemys.push(new enemy(1,25,774,546,60,1000,560,random(1,4),"image/zz.gif","image/h.png"));
        }
        //大飞机
        // if(mark1==20){
        //     enemys.push(new enemy(1,57,810,110,164,30000,540,(1,4),"image/dd.gif","image/enemy2_fly_1.png"));
        //     mark1=0;
        // }
        //小飞机
        else{
            enemys.push(new enemy(1,19,740,34,24,1000,560,random(1,4),"image/xx.gif","image/c.png"));
        }
        mark=0;
    }
...
/*
 如果敌机超出边界,删除敌机
 */
        if(enemys[i].imagenode.offsetTop>1000){
...
*/
    if(mark%5==0){
            bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+1,parseInt(selfplan.imagenode.style.top)-50));
    }
